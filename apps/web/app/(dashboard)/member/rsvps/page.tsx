 ...
 * "My RSVPs" (EVT-01).
 *
 * The member dashboard has linked here since the dashboard was built; the page
 * never existed, so the link 404'd. Mirrors /member/bookings.
 */
export default function MyRsvpsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">My RSVPs</h1>
