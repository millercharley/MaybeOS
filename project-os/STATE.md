...
## Next
- **IMP-05/08/09 as one piece of work** — the ImpactOS response schema: a response bound to an indicator, a question version and a collection window, with uniqueness per member per window. Everything else in the PRD traces back to it (D-021).
